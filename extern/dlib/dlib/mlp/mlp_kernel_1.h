    ...
    public:
        ...
        void train(
            ...
            if (second_hidden_nodes == 0) {
                ...
                e1 = pointwise_multiply(tmp1, uniform_matrix<double>(first_hidden_nodes + 1, 1, 1.0) - tmp1,
                                        trans(w3) * e3);
                ...
                // now compute the errors and propagate them backwards though the network
                e3 = pointwise_multiply(example_out - o, uniform_matrix<double>(output_nodes, 1, 1.0) - o, o);
                e2 = pointwise_multiply(tmp2, uniform_matrix<double>(second_hidden_nodes + 1, 1, 1.0) - tmp2,
                                        trans(w3) * e3);
                e1 = pointwise_multiply(tmp1, uniform_matrix<double>(first_hidden_nodes + 1, 1, 1.0) - tmp1,
                                        trans(w2) * e2);
