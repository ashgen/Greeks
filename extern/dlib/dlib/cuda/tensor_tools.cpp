...
#else
            cpu::batch_normalize(eps, dest, means, vars, averaging_factor, running_means, running_variances, src, gamma,
                                 beta);
#endif
        }
...
#else
            cpu::batch_normalize_gradient(eps, gradient_input, means, invstds, src, gamma, src_grad, gamma_grad,
                                          beta_grad);
#endif
        }
...
#else
            cpu::batch_normalize_conv(eps, dest, means, vars, averaging_factor, running_means, running_variances, src,
                                      gamma, beta);
#endif
        }
...
#else
            cpu::batch_normalize_conv_gradient(eps, gradient_input, means, invstds, src, gamma, src_grad, gamma_grad,
                                               beta_grad);
#endif
        }
...
#else
            cpu::layer_normalize_gradient(eps, gradient_input, means, invstds, src, gamma, src_grad, gamma_grad,
                                          beta_grad);
#endif
        }
...
#else
            cpu::resize_bilinear_gradient(grad, grad_row_stride, grad_channel_stride, gradient_input,
                                          gradient_input_row_stride, gradient_input_channel_stride);
#endif
        }
