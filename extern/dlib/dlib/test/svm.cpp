...
// ----------------------------------------------------------------------------------------
    ...
    void test_regression(
        ...
        m(0) = 2.5;
        dlog << LDEBUG << "krls: " << sinc(m(0)) << "   " << test(m);
        DLIB_TEST(abs(sinc(m(0)) - test(m)) < 0.01);
        m(0) = 0.1;
        dlog << LDEBUG << "krls: " << sinc(m(0)) << "   " << test(m);
        DLIB_TEST(abs(sinc(m(0)) - test(m)) < 0.01);
        m(0) = -4;
        ...
        m(0) = 2.5;
        dlog << LDEBUG << "rvm: " << sinc(m(0)) << "   " << test2(m);
        DLIB_TEST(abs(sinc(m(0)) - test2(m)) < 0.01);
        m(0) = 0.1;
        dlog << LDEBUG << "rvm: " << sinc(m(0)) << "   " << test2(m);
        DLIB_TEST(abs(sinc(m(0)) - test2(m)) < 0.01);
        m(0) = -4;
        ...
        m(0) = 2.5;
        dlog << LDEBUG << "rbf: " << sinc(m(0)) << "   " << test3(m);
        DLIB_TEST(abs(sinc(m(0)) - test3(m)) < 0.01);
        m(0) = 0.1;
        dlog << LDEBUG << "rbf: " << sinc(m(0)) << "   " << test3(m);
        DLIB_TEST(abs(sinc(m(0)) - test3(m)) < 0.01);
        m(0) = -4;
        ...
        m(0) = 2.5;
        dlog << LDEBUG << "krr: " << sinc(m(0)) << "   " << test4(m);
        DLIB_TEST(abs(sinc(m(0)) - test4(m)) < 0.01);
        m(0) = 0.1;
        dlog << LDEBUG << "krr: " << sinc(m(0)) << "   " << test4(m);
        DLIB_TEST(abs(sinc(m(0)) - test4(m)) < 0.01);
        m(0) = -4;
        ...
        m(0) = 2.5;
        dlog << LDEBUG << "svr: " << sinc(m(0)) << "   " << test5(m);
        DLIB_TEST(abs(sinc(m(0)) - test5(m)) < 0.01);
        m(0) = 0.1;
        dlog << LDEBUG << "svr: " << sinc(m(0)) << "   " << test5(m);
        DLIB_TEST(abs(sinc(m(0)) - test5(m)) < 0.01);
        m(0) = -4;
...
// ----------------------------------------------------------------------------------------
    ...
    void test_anomaly_detection(
        ...
        m(0) = -1.5;
        m(1) = sinc(m(0));
        DLIB_TEST_MSG(rs.scale(test(m)) < 2, rs.scale(test(m)));
        m(0) = -1.5;
        m(1) = sinc(m(0));
        DLIB_TEST_MSG(rs.scale(test(m)) < 2, rs.scale(test(m)));
        m(0) = -0;
