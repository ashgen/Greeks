            ...
            for (long o = 0; o < (long) hog.size(); ++o) {
                ...
                for (long r = 0; r < hog[o].nr(); ++r) {
                    for (long c = 0; c < hog[o].nc(); ++c) {
                        DLIB_TEST_MSG(std::abs(hog[o][r][c] - ref_hog[r][c](o)) < 1e-6,
                                      std::abs(hog[o][r][c] - ref_hog[r][c](o)));
                    }
                }
            }
        }
                        ...
                        for (long j = -10; j <= 10; ++j) {
                            for (long k = -10; k <= 10; ++k) {
                                for (long l = -10; l <= 10; ++l) {
                                    ...
                                    DLIB_TEST_MSG(rect ==
                                                  image_to_fhog(fhog_to_image(rect, cell_size, rows, cols), cell_size,
                                                                rows, cols),
                                                  " rows: " << rows <<
                                                            " cols: " << cols <<
                                                            " cell_size: " << cell_size <<
                                                            ...
                                                            " frect: "
                                                            << image_to_fhog(fhog_to_image(rect, cell_size, rows, cols),
                                                                             cell_size, rows, cols)
                                    );
                                }
                            }
