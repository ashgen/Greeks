...
namespace {
    ...
    !*/
    {
        ...
        sin.str("1860479");
        sin >> i;
        DLIB_TEST_MSG(short_fact<bint>(20) / (short_fact<bint>(15) + 1) == i,
                      short_fact<bint>(20) / (short_fact<bint>(15) + 1));
        ...
        sin.str("1860479");
        sin >> i;
        DLIB_TEST_MSG(big_fact<bint>(20) / (big_fact<bint>(15) + 1) == i,
                      big_fact<bint>(20) / (big_fact<bint>(15) + 1));
