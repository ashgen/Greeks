...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        const assignment_function <feature_extractor> train(
            ...
            structural_svm_assignment_problem<feature_extractor> prob(samples, labels, fe, force_assignment,
                                                                      num_threads,
            ...
            return assignment_function<feature_extractor>(colm(weights, 0, weights.size() - 1), bias, fe,
                                                          force_assignment);
